...
class AliasSetSegmentation : public llvm::ModulePass {
 public:
  ...
  SegmentationTable* OffsetMerge(SegmentationTable* one, SegmentationTable* two,
                                 Range Offset);
  SegmentationTable* MultiplicationMerge(SegmentationTable* one,
                                         SegmentationTable* two);
  void ContentMerge(SegmentationTable* result, SegmentationTable* one,
                    SegmentationTable* two);
