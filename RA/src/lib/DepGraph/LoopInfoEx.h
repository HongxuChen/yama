...
class LoopInfoExIterator {
 ...
 public:
  ...
  LoopInfoExIterator(LoopInfo::iterator initValue,
                     LoopInfo::iterator endValue) {
  ...
  bool operator==(LoopInfoExIterator RHS) {
    ...
    return (this->topLevelLoops == RHS.topLevelLoops &&
            this->innerLoops == RHS.innerLoops);
  }

  bool operator!=(LoopInfoExIterator RHS) { return !(operator==(RHS)); }
