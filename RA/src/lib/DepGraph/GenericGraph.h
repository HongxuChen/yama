...
class GenericGraph {
 ...
 public:
  ...
  GenericGraphNode<T>* addNode(
      T element);  // Add an instruction into Dependence Graph
  ...
  GenericGraphNode<T>* findNode(T element);  // Return the pointer to the node
                                             // or NULL if it is not in the
                                             // graph
  GenericGraphNode<T>* findNode(GenericGraphNode<T>* node);  // Return the
                                                             // pointer to the
                                                             // node or NULL if
                                                             // it is not in the
                                                             // graph
  ...
  void dfsVisit(GenericGraphNode<T>* u,
                std::set<GenericGraphNode<T>*>&
                    visitedNodes);  // Used by findConnectingSubgraph() method
  void dfsVisitBack(
      GenericGraphNode<T>* u,
      std::set<GenericGraphNode<T>*>&
          visitedNodes);  // Used by findConnectingSubgraph() method
