...
class AliasSets : public ModulePass {
 private:
  llvm::DenseMap<int, int> disjointSet;  // maps integers to the disjoint sets
                                         // that contains the integer
  llvm::DenseMap<int, std::set<int> > disjointSets;  // table of disjoint sets

  llvm::DenseMap<const Value *, int> valueDisjointSet;  // maps integers to the
                                                        // disjoint sets that
                                                        // contains the integer
  llvm::DenseMap<int, std::set<Value *> >
      valueDisjointSets;  // table of disjoint sets
